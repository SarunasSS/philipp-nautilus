...
def _run_htf_sweep_cisd(
    ...
    htf_bar_type: Annotated[
        BarType,
        typer.Option("--htf-bar-type", parser=BarType.from_str, help="Composite/internal HTF bar type to subscribe to"),
    ],
    ltf_bar_type: Annotated[
        ...
        typer.Option(
            ...
            help="LTF bar type to subscribe to; a composite is loaded from its catalog source",
        ),
    ],
    ...
    _run_backtest(
        ...
        bar_types=[ltf_bar_type, htf_bar_type],
