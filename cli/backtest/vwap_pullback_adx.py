...
def _run_vwap_pullback_adx(
    ...
    bar_type: Annotated[
        ...
        typer.Option(
            ...
            help="One-minute bar type; a composite is loaded from its catalog source, which becomes the bar magnifier",
        ),
    ],
    ...
    requested_bar_type = bar_type.composite() if bar_type.is_composite() else bar_type
